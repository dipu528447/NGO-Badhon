...
public class addmission extends JPanel{
	BufferedImage image;
	Image images;
	...
	public addmission(seasionbean s,JFrame f)
	{
		try {
			db.conect();
	...
	public void btnwrk()
	{
		...
		btnupload2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				id_pic=file.getPath().toString().substring(3,file.getPath().toString().length());
		...
		btnupdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(valid()==true)
				{
					...
					{
						try {
							System.out.print("update member_info set occupation='"+txtoccupation.getText().trim().toString()+"',nominirltn='"+txtnominirltn.getText().trim().toString()+"',nomininame='"+txtnomini.getText().trim().toString()+"',age='"+txtage.getText().trim().toString()+"',mothername='"+txtmothername.getText().trim().toString()+"',husbandname='"+txthusbandname.getText().trim().toString()+"',fathername='"+txtfathername.getText().trim().toString()+"',name_eng='"+txtnameinenglish.getText().trim().toString()+"',name_ban='"+txtnameinbangla.getText().trim().toString()+"',savings="+txtsavings.getText()+",loan="+txtloan.getText()+",loan_installment="+txtloaninstallment.getText()+",dps_year="+txtdpsyear.getText().trim().toString()+",dps_savings="+txtdpssavings.getText()+",dps_category="+txtcategory.getText().trim().toString()+",addmission_date="+new SimpleDateFormat("YYYYMMdd").format(joindate.getDate())+",pic_form='"+form_pic+"',pic_id='"+id_pic+"' where account="+txtmemberno.getText()+" && groupno=(select id from group_info where groupno='"+cmbgroupno.getSelectedItem().toString()+"' && activity='y' && product=(select id from product where product_name='"+cmbproduct.getSelectedItem().toString()+"')) && product=(select id from product where product_name='"+cmbproduct.getSelectedItem().toString()+"')");
							db.sta.execute("update member_info set occupation='"+txtoccupation.getText().trim().toString()+"',nominirltn='"+txtnominirltn.getText().trim().toString()+"',nomininame='"+txtnomini.getText().trim().toString()+"',age='"+txtage.getText().trim().toString()+"',mothername='"+txtmothername.getText().trim().toString()+"',husbandname='"+txthusbandname.getText().trim().toString()+"',fathername='"+txtfathername.getText().trim().toString()+"',name_eng='"+txtnameinenglish.getText().trim().toString()+"',name_ban='"+txtnameinbangla.getText().trim().toString()+"',savings="+txtsavings.getText()+",loan="+txtloan.getText()+",loan_installment="+txtloaninstallment.getText()+",dps_year="+txtdpsyear.getText().trim().toString()+",dps_savings="+txtdpssavings.getText()+",dps_category="+txtcategory.getText().trim().toString()+",addmission_date="+new SimpleDateFormat("YYYYMMdd").format(joindate.getDate())+",pic_form='"+form_pic+"',pic_id='"+id_pic+"' where account="+txtmemberno.getText()+" && groupno=(select id from group_info where groupno='"+cmbgroupno.getSelectedItem().toString()+"' && activity='y' && product=(select id from product where product_name='"+cmbproduct.getSelectedItem().toString()+"')) && product=(select id from product where product_name='"+cmbproduct.getSelectedItem().toString()+"')");
							reset();
							load();
		...
		btnprint.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					HashMap map=null;
					map=new HashMap();
					map.put("pic","F://"+form_pic);
					map.put("picid","F://"+id_pic);
				
					
					list.add(map);	
					JasperPrint jp=null;
					String input = "report/pic.jrxml";
	...
	public void pnltxtwrk()
	{
		...
		pnltxt.setPreferredSize(new Dimension(450,580));
