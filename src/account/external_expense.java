...
public class external_expense extends JPanel{
	BufferedImage image;
	...
	public external_expense(seasionbean s)
	{
		try {
			db.conect();
	...
	public void btnwrk()
	{
		...
		btnsubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int a=JOptionPane.showConfirmDialog(null,"Are you sure to Occur This Transaction?","Confirm",JOptionPane.YES_NO_OPTION);
...
//		});
	...
	public void load()
	{
		...
		try {
			cmbpurpose.addItem(" ");
			ResultSet r=db.sta.executeQuery("select ledger_name from ledger where recieve_payment=2 && activition='y'");
			while(r.next())
			{
